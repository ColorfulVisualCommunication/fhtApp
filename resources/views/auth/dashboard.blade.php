...
<div class="absolute p-4 top-32 border border-l-slate-500 border-t-sky-700 border-r-sky-500 border-b-sky-300 lg:top-64 hover:underline underline-offset-4 decoration-1 decoration-slate-500 text-6xl hover:text-yellow-500 lg:text-9xl text-white">
