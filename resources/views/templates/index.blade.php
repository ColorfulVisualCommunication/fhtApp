...
<div class="absolute p-4 top-32 border border-l-slate-500 border-t-sky-700 border-r-sky-500 border-b-sky-300 lg:top-64 text-6xl lg:text-9xl text-white">
	<span class="text-yellow-500 hover:text-slate-500">W</span> E L C O M E
</div>
<div class="m-2  max-w-lg md:max-w-4xl lg:max-w-5xl rounded overflow-hidden shadow-lg">
  <img class="w-ful" src="{{ URL('storage/images/img6.jpg')}}" alt="abstract black and sky-blue">
  <div class="px-6 py-4">
    <div class="font-bold text-xl border border-l-slate-500 p-2 text-yellow-600 mb-2">Passion led us here</div>
